...
author: ["A Solomon Kurz", "Randall Pruim"]
date: "`r Sys.Date()`"
...
This revision by Randall Pruim is aimed primarily at using 
[**ggformula**](http://www.mosaic-web.org/ggformula/)
for graphics.
The main advantages of **ggformula**:

* a formula-based syntax (similar to what is used by {brms});
* smoother compatibility with {tidyverse};
* more consice code.

In principle, anything that can be done with **ggformula** can be done with
{ggplot2}, so this is a bit of syntactic sugar.  But it is nice sugar.

Additinonal things may be added/modified as well as I go along, including

* Not naming everything `d`.
...
This is the first attempt at a **ggformula** conversion and is a work in progress.
Progress will roughly parallel my Spring 2021 course.
...
@book{kurzStatisticalRethinkingSecondEd2020,
  title = {Statistical {R}ethinking with brms, ggformula, and the tidyverse: {{Second}} edition},
  author = {Kurz, A. Solomon and Pruim, Randall},
  year = {2021},
  month = {feb},
  edition = {version 0.1.2},
  url = {https://rpruim.github.io/Statistical_Rethinking_with_brms_2_ed/}
}
```
